...
function generarPregunta() {
  ...
  pregunta.textContent = `${acordeActual.raiz} ${acordeActual.nombreTipoAcorde} (${formula}) — ${acordeActual.nombreInversion}`;
...
function validarRespuesta() {
  ...
  if (valor === "") {
    resultado.textContent = "Escribe las notas del acorde antes de validar.";
    resultado.className = "resultado incorrecto";
    return;
  }

  const esCorrecta = esAcordeCorrecto(valor, acordeActual.notasEsperadas);
